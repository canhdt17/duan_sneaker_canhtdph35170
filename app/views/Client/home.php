...
?>
    ...
    <div class="hero-section">
        <div class="hero-slider">
            ...
            <div class="signle-slide" style="background-image: url('uploads/<?=$banner['hinh']?>');">
                <div class="container" style="margin-bottom: 150px;">
                    <div class="row align-items-center" >
                        <div class="col-lg-6 col-6" >
                            <div class="hero-slider-content text-center">
                                <h2 class="slider-sub-title"><?=$banner['tieude']?></h2>
                                <h1 class="slider-title"><?=$banner['tieudephu']?></h1>
                                <p class="slider-text"><?=$banner['mota']?></p>
                                <div class="slider-btn">
                                    <a href="<?=$banner['link']?>" class="primary-btn">Mua Ngay!</a>
                                    <a href="<?=$banner['link']?>" class="secondary-btn">Xem Ngay<i class="iocn flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                        </div>                    
                    </div>
    ...
    <div class="product-banner pb-100">
        <div class="container">
            <div class="row">
                <?php  
                $bannercon1=loadAll_bannercon_1();
                $bannercon2=loadAll_bannercon_2();
                extract($bannercon1);
                extract($bannercon2);
                ?>
                <div class="col-md-5">
                    <a href="<?=$bannercon1['link']?>" class="single-banner"><img class="banner-image" src="uploads/<?=$bannercon1['hinh']?>" alt="product-banner" /></a>
                </div>
                <div class="col-md-7">
                    <a href="<?=$bannercon2['link']?>" class="single-banner"><img class="banner-image" src="uploads/<?=$bannercon2['hinh']?>" alt="product-banner" /></a>
                </div>
            </div>
        </div>
    </div>
