<?php
   ...
   function loadAll_id_sanpham(){
    ...
    // thêm mới sản phẩm 
    function  insert_sanpham($ten,$gia,$mota,$id_nhom_sp,$id_gioitinh_sp,$hinh_daidien){
        $sql = "INSERT INTO san_pham(ten_sanpham,gia,mota,id_nhom_sp,id_gioitinh_sp,hinh_daidien) VALUES ('$ten','$gia','$mota','$id_nhom_sp','$id_gioitinh_sp','$hinh_daidien') ";
    ...
    //cập nhập sản phẩm
    function update_sanpham($id_sanpham,$ten,$gia,$mota,$id_nhom_sp,$id_gioitinh_sp,$hinh_daidien){

        $sql = "update san_pham set ten_sanpham='".$ten."',gia='".$gia."',mota='".$mota."',id_nhom_sp='".$id_nhom_sp."',id_gioitinh_sp='".$id_gioitinh_sp."',hinh_daidien='".$hinh_daidien."' where id_sanpham=".$id_sanpham;
        pdo_execute($sql);
    }
