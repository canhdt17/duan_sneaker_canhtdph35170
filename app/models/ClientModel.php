<?php
    ...
    //hiển thi banner con 1 
    function loadAll_bannercon_1(){
        $sql = " SELECT * FROM banner_con order by id_banner_con desc limit 0,1";
        $bannercon_1 = pdo_query_one($sql);
        return $bannercon_1;
    }
    //hiển thi banner con 2 
    function loadAll_bannercon_2(){
        $sql = " SELECT * FROM banner_con order by id_banner_con asc limit 0,1";
        $bannercon_2 = pdo_query_one($sql);
        return $bannercon_2;
    }
